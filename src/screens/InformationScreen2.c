...
/********************************************** CHART **********************************************/
    ...
    lv_chart_set_axis_tick(ui_chart2_temp, LV_CHART_AXIS_PRIMARY_Y, 5, 5, 10, 10, false, 20);
...
/********************************************** OPTION COMPONENT **********************************************/
    create_ui_back_btn(ui_infor_screen_2,GET_INFOR_PAGE_123456);
    ...
    ui_option_card_info2 = lv_obj_create(ui_infor_screen_2);
    lv_obj_set_width(ui_option_card_info2, WIDTH_OPTION_CARD);
    lv_obj_set_height(ui_option_card_info2, HEIGHT_CARD_INFO);
    lv_obj_set_x(ui_option_card_info2, POS_X_OPTION_CARD);
    lv_obj_set_y(ui_option_card_info2, POS_Y_CARD_INFO);
    lv_obj_set_align(ui_option_card_info2, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_option_card_info2, LV_OBJ_FLAG_SCROLLABLE); /// Flags
    lv_obj_set_style_radius(ui_option_card_info2, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_option_card_info2, lv_color_hex(0x464B55), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_option_card_info2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_option_card_info2, lv_color_hex(0x2D323C), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui_option_card_info2, LV_GRAD_DIR_VER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui_option_card_info2, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_option_card_info2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_flag(ui_option_card_info2, LV_OBJ_FLAG_HIDDEN);
    ...
    lv_obj_set_x(ui_name_op_t_2, 17);
    lv_obj_set_y(ui_name_op_t_2, -80);
    ...
    lv_obj_set_x(ui_pos_op_t_2, 20);
    lv_obj_set_y(ui_pos_op_t_2, 10);
    ...
    lv_obj_set_x(ui_save_btn_2, 110);
    lv_obj_set_y(ui_save_btn_2, 100);
    ...
    lv_obj_set_x(ui_cancel_btn_2, 180);
    lv_obj_set_y(ui_cancel_btn_2, 100);
 ...
 /********************************************** ARC TEMP **********************************************/
    // ui_arc_temp_info_2 = lv_arc_create(ui_infor_screen_2);
    // lv_obj_set_width(ui_arc_temp_info_2, SIZE_ARCTEMP_INFOR);
    // lv_obj_set_height(ui_arc_temp_info_2, SIZE_ARCTEMP_INFOR);
    // lv_obj_set_x(ui_arc_temp_info_2, POS_X_ARC_INFOR);
    // lv_obj_set_y(ui_arc_temp_info_2, POS_Y_ARC_INFOR);  
    // lv_obj_set_align(ui_arc_temp_info_2, LV_ALIGN_CENTER);
    // lv_arc_set_range(ui_arc_temp_info_2, MIN_RANGE_ARC, MAX_RANGE_ARC);
    // lv_arc_set_value(ui_arc_temp_info_2, START_VALUE_ARC);
    // lv_arc_set_bg_angles(ui_arc_temp_info_2, START_ANGLE_ARC, END_ANGLE_ARC);
    // lv_obj_set_style_radius(ui_arc_temp_info_2, SIZE_ARCTEMP_INFOR, LV_PART_MAIN | LV_STATE_DEFAULT);
    // lv_obj_set_style_bg_color(ui_arc_temp_info_2, lv_color_hex(0x1E232D), LV_PART_MAIN | LV_STATE_DEFAULT);
    // lv_obj_set_style_bg_opa(ui_arc_temp_info_2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    // lv_obj_set_style_pad_left(ui_arc_temp_info_2, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    // lv_obj_set_style_pad_right(ui_arc_temp_info_2, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    // lv_obj_set_style_pad_top(ui_arc_temp_info_2, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    // lv_obj_set_style_pad_bottom(ui_arc_temp_info_2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    // lv_obj_set_style_arc_color(ui_arc_temp_info_2, lv_color_hex(0x0F1215), LV_PART_MAIN | LV_STATE_DEFAULT);
    // lv_obj_set_style_arc_opa(ui_arc_temp_info_2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    // lv_obj_set_style_arc_width(ui_arc_temp_info_2, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
    // lv_obj_set_style_arc_rounded(ui_arc_temp_info_2, true, LV_PART_MAIN | LV_STATE_DEFAULT);
    // lv_obj_set_style_arc_width(ui_arc_temp_info_2, 10, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    // lv_obj_set_style_arc_rounded(ui_arc_temp_info_2, true, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    // lv_obj_set_style_arc_opa(ui_arc_temp_info_2, 0, LV_PART_KNOB | LV_STATE_DEFAULT);
    // lv_obj_set_style_radius(ui_arc_temp_info_2, 10, LV_PART_KNOB | LV_STATE_DEFAULT);
    // lv_obj_set_style_bg_color(ui_arc_temp_info_2, lv_color_hex(0xFFFFFF), LV_PART_KNOB | LV_STATE_DEFAULT);
    // lv_obj_set_style_bg_opa(ui_arc_temp_info_2, 0, LV_PART_KNOB | LV_STATE_DEFAULT);
    // lv_obj_clear_flag(ui_arc_temp_info_2, LV_OBJ_FLAG_CLICKABLE);

    // ui_arc_inner_1 = lv_obj_create(ui_infor_screen_2);
    ...
    // ui_arc_inner_2 = lv_obj_create(ui_infor_screen_2);
    ...
    ui_temp_t_info_device2 = lv_label_create(ui_infor_screen_2);
    lv_obj_set_width(ui_temp_t_info_device2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_temp_t_info_device2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_temp_t_info_device2, POS_X_ARC_INFOR);          
    lv_obj_set_y(ui_temp_t_info_device2, POS_Y_ARC_INFOR);  
    lv_obj_set_align(ui_temp_t_info_device2, LV_ALIGN_CENTER);
    lv_label_set_text(ui_temp_t_info_device2, "0 °C");
    lv_obj_set_style_text_color(ui_temp_t_info_device2, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_temp_t_info_device2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_temp_t_info_device2, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_clear_flag(ui_temp_t_info_device2, LV_OBJ_FLAG_CLICKABLE);
    ...
    lv_label_set_text(ui_name_t_info_device2,"Device 2"); 
    ...
    lv_label_set_text(ui_pos_t_device2,"Position 2"); 
    ...
    ui_last_up_t_info_device2 = lv_label_create(ui_infor_screen_2);
    lv_obj_set_width(ui_last_up_t_info_device2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_last_up_t_info_device2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_last_up_t_info_device2, POS_X_ARC_INFOR); 
    lv_obj_set_y(ui_last_up_t_info_device2, POS_Y_LASTUP_T_INFO);
    lv_obj_set_align(ui_last_up_t_info_device2, LV_ALIGN_CENTER);
    lv_label_set_text(ui_last_up_t_info_device2, "Last update : 3:50 PM");
    lv_obj_set_style_text_color(ui_last_up_t_info_device2, lv_color_hex(0xB3B3B3), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_last_up_t_info_device2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_last_up_t_info_device2, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_clear_flag(ui_last_up_t_info_device2, LV_OBJ_FLAG_CLICKABLE);

/********************************************** KEYBOARD **********************************************/
    ui_keyboard_info_2 = lv_keyboard_create(ui_infor_screen_2);
    lv_obj_set_width(ui_keyboard_info_2, 478);
    lv_obj_set_height(ui_keyboard_info_2, 214);
    lv_obj_set_x(ui_keyboard_info_2, 0);
    lv_obj_set_y(ui_keyboard_info_2, 51);
    ...
    lv_textarea_set_placeholder_text(ui_name_t_area_device2, "Device name");
    ...
    lv_textarea_set_placeholder_text(ui_pos_name_t_area_device2, "Position name");
