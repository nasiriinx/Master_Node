...
/********************************************** CARD **********************************************/
 ...
 /********************************************** VIEW BUTTON **********************************************/   
    ...
    lv_obj_set_x(ui_view_btn3, POS_X_VIEW_BTN);
...
/********************************************** OPTION COMPONENT **********************************************/
 ...
 /********************************************** ARC TEMP **********************************************/
    ...
    lv_obj_set_style_text_font(ui_temp_t_device3, &lv_font_montserrat_42, LV_PART_MAIN | LV_STATE_DEFAULT);
...
/********************************************** KEYBOARD **********************************************/
    ...
    lv_textarea_set_placeholder_text(ui_name_t_area_device3, name.device3);
    ...
    lv_textarea_set_placeholder_text(ui_pos_name_t_area_device3, pos_n.device3);
