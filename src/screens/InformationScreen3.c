...
//     lv_obj_set_x(ui_name_op_t_3, POS_X_NAME_OP_T);
//     lv_obj_set_y(ui_name_op_t_3, POS_Y_NAME_OP_T);
//     lv_obj_set_align(ui_name_op_t_3, LV_ALIGN_CENTER);
//     lv_label_set_text(ui_name_op_t_3, "Device Name");
...
//     lv_obj_set_x(ui_pos_op_t_3, POS_X_POS_OP_T);
//     lv_obj_set_y(ui_pos_op_t_3, POS_Y_POS_OP_T);
//     lv_obj_set_align(ui_pos_op_t_3, LV_ALIGN_CENTER);
//     lv_label_set_text(ui_pos_op_t_3, "Position Name");
...
//     lv_obj_set_x(ui_save_btn_3, POS_X_SAVE_BTN);
//     lv_obj_set_y(ui_save_btn_3, POS_Y_INFO_OP_BTN);
...
//     lv_obj_set_x(ui_cancel_btn_3, POS_X_CANCEL_BTN);
//     lv_obj_set_y(ui_cancel_btn_3, POS_Y_INFO_OP_BTN);
...
//  /********************************************** ARC TEMP **********************************************/
//     ui_arc_temp_3 = lv_arc_create(ui_infor_screen_3);
//     lv_obj_set_width(ui_arc_temp_3, SIZE_ARCTEMP_INFOR);
//     lv_obj_set_height(ui_arc_temp_3, SIZE_ARCTEMP_INFOR);
//     lv_obj_set_x(ui_arc_temp_3, POS_X_ARC_INFOR);
//     lv_obj_set_y(ui_arc_temp_3, POS_Y_ARC_INFOR);  
...
//     lv_obj_set_style_radius(ui_arc_temp_3, SIZE_ARCTEMP_INFOR, LV_PART_MAIN | LV_STATE_DEFAULT);
...
//     lv_obj_set_style_arc_width(ui_arc_temp_3, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
//     lv_obj_set_style_arc_rounded(ui_arc_temp_3, true, LV_PART_MAIN | LV_STATE_DEFAULT);
//     lv_obj_set_style_arc_width(ui_arc_temp_3, 10, LV_PART_INDICATOR | LV_STATE_DEFAULT);
//     lv_obj_set_style_arc_rounded(ui_arc_temp_3, true, LV_PART_INDICATOR | LV_STATE_DEFAULT);
//     lv_obj_set_style_arc_opa(ui_arc_temp_3, 0, LV_PART_KNOB | LV_STATE_DEFAULT);
...
//     ui_temp_t_device3 = lv_label_create(ui_infor_screen_3);
//     lv_obj_set_width(ui_temp_t_device3, LV_SIZE_CONTENT);   /// 1
//     lv_obj_set_height(ui_temp_t_device3, LV_SIZE_CONTENT);    /// 1
//     lv_obj_set_x(ui_temp_t_device3, POS_X_ARC_INFOR);          
//     lv_obj_set_y(ui_temp_t_device3, POS_Y_ARC_INFOR);  
...
//     lv_obj_set_style_text_font(ui_temp_t_device3, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
...
//     ui_last_up_t_device3 = lv_label_create(ui_infor_screen_3);
//     lv_obj_set_width(ui_last_up_t_device3, LV_SIZE_CONTENT);   /// 1
//     lv_obj_set_height(ui_last_up_t_device3, LV_SIZE_CONTENT);    /// 1
//     lv_obj_set_x(ui_last_up_t_device3, POS_X_ARC_INFOR); 
//     lv_obj_set_y(ui_last_up_t_device3, POS_Y_LASTUP_T_INFO);
...
//     lv_obj_set_x(ui_keyboard_info_3, POS_X_KEYBOARD);
//     lv_obj_set_y(ui_keyboard_info_3, POS_Y_KEYBOARD);
