...
void ui_InforScr7_screen_init(void){
    ...
    lv_chart_set_range(ChartTempInfo7, LV_CHART_AXIS_PRIMARY_Y, -20, 40);
    lv_chart_set_update_mode(ChartTempInfo7, LV_CHART_UPDATE_MODE_SHIFT);
    lv_chart_set_div_line_count(ChartTempInfo7, 20, 20);
    lv_chart_set_axis_tick(ChartTempInfo7, LV_CHART_AXIS_PRIMARY_Y, 5, 5, 10, 10, true, 20);
    ...
    ChartTempInfo7_series_1 = lv_chart_add_series(ChartTempInfo7, lv_color_hex(0x464B55),LV_CHART_AXIS_PRIMARY_Y);
    ...
    lv_obj_set_style_text_font(ChartTempInfo7, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ChartTempInfo7, lv_color_hex(0xFFFFFF), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ChartTempInfo7, 0, LV_PART_INDICATOR | LV_STATE_DEFAULT);
