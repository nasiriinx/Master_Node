...
void ui_Screen1_screen_init(void)
{
    ...
    ui_HeaderPanel1 = lv_obj_create(ui_Screen1);
    lv_obj_set_width(ui_HeaderPanel1, 783);
    lv_obj_set_height(ui_HeaderPanel1, 37);
    lv_obj_set_x(ui_HeaderPanel1, 0);
    lv_obj_set_y(ui_HeaderPanel1, -143);
    lv_obj_set_align(ui_HeaderPanel1, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_HeaderPanel1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_HeaderPanel1, lv_color_hex(0x292929), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_HeaderPanel1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui_HeaderPanel1, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_HeaderPanel1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_DateHeader1 = lv_label_create(ui_Screen1);
    ...
    lv_arc_set_range(ui_ArcTemp1, -20, 10);
    ...
    lv_obj_clear_flag(ui_Arc1inner1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_label_set_text(ui_DeviceName1, "ESP32-Node 1");
    ...
    lv_label_set_text(ui_LastUp1, "Last update : 3:50PM");
    ...
    lv_label_set_text(ui_DeviceName2, "ESP32-Node 2");
    ...
    lv_arc_set_range(ui_ArcTemp2, -20, 10);
    ...
    lv_obj_clear_flag(ui_Arc1inner2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_style_text_font(ui_TempCard2, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_DeviceName3, "ESP32-Node 3");
    ...
    lv_arc_set_range(ui_ArcTemp3, -20, 10);
    ...
    lv_obj_clear_flag(ui_Arc1inner3, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_label_set_text(ui_DeviceName4, "ESP32-Node 4");
    ...
    lv_arc_set_range(ui_ArcTemp4, -20, 10);
    ...
    lv_obj_clear_flag(ui_Arc1inner4, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_label_set_text(ui_DeviceName5, "ESP32-Node 5");
    ...
    lv_arc_set_range(ui_ArcTemp5, -20, 10);
    ...
    lv_obj_clear_flag(ui_Arc1inner5, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_label_set_text(ui_DeviceName6, "ESP32-Node 6");
    ...
    lv_arc_set_range(ui_ArcTemp6, -20, 10);
    ...
    lv_obj_clear_flag(ui_ArcBg6, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_clear_flag(ui_Arc1inner6, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_TabViewScr1 = lv_tabview_create(ui_Screen1, LV_DIR_TOP, 60);
    lv_obj_set_width(ui_TabViewScr1, 255);
    lv_obj_set_height(ui_TabViewScr1, 37);
    lv_obj_set_x(ui_TabViewScr1, -113);
    lv_obj_set_y(ui_TabViewScr1, -143);
    lv_obj_set_align(ui_TabViewScr1, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_TabViewScr1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_TabViewScr1, lv_color_hex(0x292929), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_TabViewScr1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_text_color(lv_tabview_get_tab_btns(ui_TabViewScr1), lv_color_hex(0xB5B5B5),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(lv_tabview_get_tab_btns(ui_TabViewScr1), 255,  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(lv_tabview_get_tab_btns(ui_TabViewScr1), &lv_font_montserrat_14,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(lv_tabview_get_tab_btns(ui_TabViewScr1), lv_color_hex(0x292929),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(lv_tabview_get_tab_btns(ui_TabViewScr1), 50,  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(lv_tabview_get_tab_btns(ui_TabViewScr1), lv_color_hex(0x000000),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(lv_tabview_get_tab_btns(ui_TabViewScr1), 0,  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(lv_tabview_get_tab_btns(ui_TabViewScr1), 5,  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(lv_tabview_get_tab_btns(ui_TabViewScr1), 5,  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(lv_tabview_get_tab_btns(ui_TabViewScr1), 5,  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(lv_tabview_get_tab_btns(ui_TabViewScr1), 25,  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_row(lv_tabview_get_tab_btns(ui_TabViewScr1), 5,  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_column(lv_tabview_get_tab_btns(ui_TabViewScr1), 5,  LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_text_color(lv_tabview_get_tab_btns(ui_TabViewScr1), lv_color_hex(0xFFFFFF),
                                LV_PART_ITEMS | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(lv_tabview_get_tab_btns(ui_TabViewScr1), 255,  LV_PART_ITEMS | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(lv_tabview_get_tab_btns(ui_TabViewScr1), LV_TEXT_ALIGN_CENTER,
                                LV_PART_ITEMS | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(lv_tabview_get_tab_btns(ui_TabViewScr1), &lv_font_montserrat_14,
                               LV_PART_ITEMS | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(lv_tabview_get_tab_btns(ui_TabViewScr1), lv_color_hex(0x292929),
                              LV_PART_ITEMS | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(lv_tabview_get_tab_btns(ui_TabViewScr1), 255,  LV_PART_ITEMS | LV_STATE_DEFAULT);

    ui_Monitoring1 = lv_tabview_add_tab(ui_TabViewScr1, "Monitor");

    ui_Rename1 = lv_tabview_add_tab(ui_TabViewScr1, "Rename");

    ui_Add_Device1 = lv_tabview_add_tab(ui_TabViewScr1, "Add device");
    ...
    lv_obj_add_event_cb(ui_ArcTemp1, ui_event_ArcTemp1, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_ArcTemp2, ui_event_ArcTemp2, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_ArcTemp3, ui_event_ArcTemp3, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_ArcBg3, ui_event_ArcBg3, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_ArcTemp4, ui_event_ArcTemp4, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_ArcTemp5, ui_event_ArcTemp5, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_ArcTemp6, ui_event_ArcTemp6, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_changetoScr2btn, ui_event_changetoScr2btn, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_TabViewScr1,ui_event_TabviewScr1,LV_EVENT_ALL,NULL);
}
