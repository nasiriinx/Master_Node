...
/********************************************** CARD **********************************************/
 ...
 /********************************************** VIEW BUTTON **********************************************/   
    ...
    lv_obj_set_x(ui_view_btn10, POS_X_VIEW_BTN);
...
/********************************************** OPTION COMPONENT **********************************************/
    ui_btn_back10 = lv_btn_create(ui_infor_screen_10);
    lv_obj_set_width(ui_btn_back10, SIZE_WIDTH_BACK_BTN);
    lv_obj_set_height(ui_btn_back10, SIZE_HEIGHT_BACK_BTN);
    lv_obj_set_x(ui_btn_back10, POS_X_BACK_BTN);
    lv_obj_set_y(ui_btn_back10, POS_Y_BACK_BTN);
    lv_obj_set_align(ui_btn_back10, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_btn_back10, LV_OBJ_FLAG_SCROLL_ON_FOCUS); /// Flags
    lv_obj_clear_flag(ui_btn_back10, LV_OBJ_FLAG_SCROLLABLE);    /// Flags
    lv_obj_set_style_bg_color(ui_btn_back10, lv_color_hex(0x292929), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_btn_back10, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui_btn_back10, LV_GRAD_DIR_VER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui_btn_back10, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_btn_back10, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(ui_btn_back10, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui_btn_back10, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_t *label_sym_btn;
    label_sym_btn = lv_label_create(ui_btn_back10);
    ...
    lv_obj_add_event_cb(ui_btn_back10,ui_event_back_btn10, LV_EVENT_ALL, NULL);
 ...
 /********************************************** ARC TEMP **********************************************/
    ...
    lv_label_set_text(ui_last_up_t_info_device10, dev_uptime.dev10);
...
/********************************************** KEYBOARD **********************************************/
    ...
    lv_textarea_set_placeholder_text(ui_name_t_area_device10, name.device10);
    ...
    lv_textarea_set_placeholder_text(ui_pos_name_t_area_device10, pos_n.device10);
