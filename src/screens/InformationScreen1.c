...
//  /********************************************** ARC TEMP **********************************************/
//     ui_arc_temp_1 = lv_arc_create(ui_infor_screen_1);
//     lv_obj_set_width(ui_arc_temp_1, SIZE_ARCTEMP_INFOR);
//     lv_obj_set_height(ui_arc_temp_1, SIZE_ARCTEMP_INFOR);
//     lv_obj_set_x(ui_arc_temp_1, POS_X_ARC_INFOR);
//     lv_obj_set_y(ui_arc_temp_1, POS_Y_ARC_INFOR);  
...
//     lv_obj_set_style_radius(ui_arc_temp_1, SIZE_ARCTEMP_INFOR, LV_PART_MAIN | LV_STATE_DEFAULT);
...
//     lv_obj_set_style_arc_width(ui_arc_temp_1, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
//     lv_obj_set_style_arc_rounded(ui_arc_temp_1, true, LV_PART_MAIN | LV_STATE_DEFAULT);
//     lv_obj_set_style_arc_width(ui_arc_temp_1, 10, LV_PART_INDICATOR | LV_STATE_DEFAULT);
//     lv_obj_set_style_arc_rounded(ui_arc_temp_1, true, LV_PART_INDICATOR | LV_STATE_DEFAULT);
//     lv_obj_set_style_arc_opa(ui_arc_temp_1, 0, LV_PART_KNOB | LV_STATE_DEFAULT);
...
//     lv_obj_set_style_text_font(ui_temp_t_device1, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
