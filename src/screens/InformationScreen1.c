...
/********************************************** CHART **********************************************/
    ...
    lv_chart_set_axis_tick(ui_chart1_temp, LV_CHART_AXIS_PRIMARY_Y, 5, 5, 10, 10, false, 20);
...
/********************************************** OPTION COMPONENT **********************************************/
    create_ui_back_btn(ui_infor_screen_1,GET_INFOR_PAGE_123456);
    ...
    ui_option_card_info1 = lv_obj_create(ui_infor_screen_1);
    lv_obj_set_width(ui_option_card_info1, WIDTH_OPTION_CARD);
    lv_obj_set_height(ui_option_card_info1, HEIGHT_CARD_INFO);
    lv_obj_set_x(ui_option_card_info1, POS_X_OPTION_CARD);
    lv_obj_set_y(ui_option_card_info1, POS_Y_CARD_INFO);
    lv_obj_set_align(ui_option_card_info1, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_option_card_info1, LV_OBJ_FLAG_SCROLLABLE); /// Flags
    lv_obj_set_style_radius(ui_option_card_info1, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_option_card_info1, lv_color_hex(0x464B55), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_option_card_info1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_option_card_info1, lv_color_hex(0x2D323C), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui_option_card_info1, LV_GRAD_DIR_VER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui_option_card_info1, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_option_card_info1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_flag(ui_option_card_info1, LV_OBJ_FLAG_HIDDEN);
    ...
    lv_obj_set_x(ui_name_op_t_1, 17);
    lv_obj_set_y(ui_name_op_t_1, -80);
    lv_obj_set_align(ui_name_op_t_1, LV_ALIGN_CENTER);
    lv_label_set_text(ui_name_op_t_1, "Device Name 1");
    ...
    lv_obj_set_x(ui_pos_op_t_1, 20);
    lv_obj_set_y(ui_pos_op_t_1, 10);
    lv_obj_set_align(ui_pos_op_t_1, LV_ALIGN_CENTER);
    lv_label_set_text(ui_pos_op_t_1, "Position Name 1");
    ...
    lv_obj_set_x(ui_save_btn_1, 110);
    lv_obj_set_y(ui_save_btn_1, 100);
    ...
    lv_obj_set_x(ui_cancel_btn_1, 180);
    lv_obj_set_y(ui_cancel_btn_1, 100);
 ...
 /********************************************** ARC TEMP **********************************************/
    // ui_arc_temp_info_1 = lv_arc_create(ui_infor_screen_1);
    ...
    // ui_arc_inner_1 = lv_obj_create(ui_infor_screen_1);
    ...
    // ui_arc_inner_2 = lv_obj_create(ui_infor_screen_1);
    ...
    ui_temp_t_info_device1 = lv_label_create(ui_infor_screen_1);
    lv_obj_set_width(ui_temp_t_info_device1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_temp_t_info_device1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_temp_t_info_device1, POS_X_ARC_INFOR);          
    lv_obj_set_y(ui_temp_t_info_device1, POS_Y_ARC_INFOR);  
    lv_obj_set_align(ui_temp_t_info_device1, LV_ALIGN_CENTER);
    lv_label_set_text(ui_temp_t_info_device1, "0 °C");
    lv_obj_set_style_text_color(ui_temp_t_info_device1, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_temp_t_info_device1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_temp_t_info_device1, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_clear_flag(ui_temp_t_info_device1, LV_OBJ_FLAG_CLICKABLE);

    ui_name_t_info_device1 = lv_label_create(ui_infor_screen_1);
    lv_obj_set_width(ui_name_t_info_device1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_name_t_info_device1, LV_SIZE_CONTENT);    /// 1
    ...
    lv_label_set_text(ui_name_t_info_device1,"Device 1"); 
    ...
    lv_label_set_text(ui_pos_t_device1,"Position 1"); 
    ...
    ui_last_up_t_info_device1 = lv_label_create(ui_infor_screen_1);
    lv_obj_set_width(ui_last_up_t_info_device1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_last_up_t_info_device1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_last_up_t_info_device1, POS_X_ARC_INFOR); 
    lv_obj_set_y(ui_last_up_t_info_device1, POS_Y_LASTUP_T_INFO);
    lv_obj_set_align(ui_last_up_t_info_device1, LV_ALIGN_CENTER);
    lv_label_set_text(ui_last_up_t_info_device1, "Last update : 3:50 PM");
    lv_obj_set_style_text_color(ui_last_up_t_info_device1, lv_color_hex(0xB3B3B3), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_last_up_t_info_device1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_last_up_t_info_device1, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_clear_flag(ui_last_up_t_info_device1, LV_OBJ_FLAG_CLICKABLE);

/********************************************** KEYBOARD **********************************************/
    ui_keyboard_info_1 = lv_keyboard_create(ui_infor_screen_1);
    lv_obj_set_width(ui_keyboard_info_1, 478);
    lv_obj_set_height(ui_keyboard_info_1, 214);
    lv_obj_set_x(ui_keyboard_info_1, 0);
    lv_obj_set_y(ui_keyboard_info_1, 51);
    lv_obj_set_align(ui_keyboard_info_1, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_keyboard_info_1, LV_OBJ_FLAG_HIDDEN); /// Flags675  
    ...
    lv_textarea_set_placeholder_text(ui_name_t_area_device1, "Device name");
    ...
    lv_textarea_set_placeholder_text(ui_pos_name_t_area_device1, "Position name");
