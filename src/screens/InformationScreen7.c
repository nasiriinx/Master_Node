...
/********************************************** OPTION COMPONENT **********************************************/
    create_ui_back_btn(ui_infor_screen_7,GET_INFOR_PAGE_78910);
    // ui_btn_back5 = lv_btn_create(ui_infor_screen_7);
    ...
    // lv_obj_add_event_cb(ui_btn_back5,ui_event_back_btn7, LV_EVENT_ALL, NULL);

    ui_option_card_info7 = lv_obj_create(ui_infor_screen_7);
    lv_obj_set_width(ui_option_card_info7, WIDTH_OPTION_CARD);
    lv_obj_set_height(ui_option_card_info7, HEIGHT_CARD_INFO);
    lv_obj_set_x(ui_option_card_info7, POS_X_OPTION_CARD);
    lv_obj_set_y(ui_option_card_info7, POS_Y_CARD_INFO);
    lv_obj_set_align(ui_option_card_info7, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_option_card_info7, LV_OBJ_FLAG_SCROLLABLE); /// Flags
    lv_obj_set_style_radius(ui_option_card_info7, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_option_card_info7, lv_color_hex(0x464B55), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_option_card_info7, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_option_card_info7, lv_color_hex(0x2D323C), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui_option_card_info7, LV_GRAD_DIR_VER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui_option_card_info7, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_option_card_info7, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_flag(ui_option_card_info7, LV_OBJ_FLAG_HIDDEN);
    ...
    lv_label_set_text(ui_name_op_t_7, "Device Name 1");
    ...
    lv_label_set_text(ui_pos_op_t_7, "Position Name 1");
 ...
 /********************************************** ARC TEMP **********************************************/
    // ui_arc_temp_info_1 = lv_arc_create(ui_infor_screen_7);
    ...
    // ui_arc_inner_1 = lv_obj_create(ui_infor_screen_7);
    ...
    // ui_arc_inner_2 = lv_obj_create(ui_infor_screen_7);
    ...
    lv_label_set_text(ui_temp_t_info_device7, "0 °C");
    ...
    lv_obj_set_style_text_font(ui_temp_t_info_device7, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_name_t_info_device7,"Device 1"); 
    ...
    lv_label_set_text(ui_pos_t_device7,"Position 1"); 
    ...
    lv_label_set_text(ui_last_up_t_info_device7, "Last update : 3:50 PM");
...
/********************************************** KEYBOARD **********************************************/
    ...
    lv_textarea_set_placeholder_text(ui_name_t_area_device7, "Device name");
    ...
    lv_textarea_set_placeholder_text(ui_pos_name_t_area_device7, "Position name");
